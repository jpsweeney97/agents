...
import json, random, shutil, subprocess, sys, tarfile, tempfile, hashlib
...
if __name__ == "__main__":
    ...
    if cmd == "record":
        ...
        # (new trial ids) via the derived schedule-extensions.json.
...
(d / "sentinel-absent.json").write_text("[]")
p = run(d, "record")
