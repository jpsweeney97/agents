...
run_one() {
  ...
  {
    echo "You are the assistant in the conversation below. You are running the skill whose full text follows. Write only your next assistant turn, exactly as you would send it to the user. Do not use tools. Do not explain your reasoning outside the turn."
