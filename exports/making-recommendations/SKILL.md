...
description: "Use when the user asks for a recommendation, comparison, trade-off, ranking, or decision between two or more serious, comparable options. Not for factual questions, trivial preferences, or descoping."
---

<!-- export: plugins/decide/skills/making-recommendations/ @ 6d0d9c594cef973af37d37e5e506b0ceea5aad88 | 2026-09-23 | claude.ai -->
...
- A scope cut, not a pick — the ask partitions one scope into keep/defer/cut under a binding constraint (deadline, risk, or capacity), not a pick-one choice among rivals. Say so and offer that partition, which keeps every cut item with a re-entry condition, instead of forcing a ranking.
...
- The relevant review, status, source-of-truth, debugging, planning, or implementation skill where one is available, otherwise a plain statement of which kind of work the request really is — when the request is not primarily a choice.
