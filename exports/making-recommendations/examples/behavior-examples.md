...
- Say the owning move is a scope cut, not a recommendation: partition the one scope into keep/defer/cut under the binding constraint, preserving every cut item with a re-entry condition. Ask before switching, then stop.
